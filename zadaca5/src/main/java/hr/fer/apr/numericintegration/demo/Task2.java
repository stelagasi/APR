...
//        rungeKuttaMethod.apply(A, x0, B, null, T, T, tMax, 1, false);
...
//        trapezoidalMethod.apply(x0, null, T, T, tMax, 1, false);
...
//        eulerMethod.apply(A, x0, B, null, T, T, tMax, 1, false);
...
//        backwardEulerMethod.apply(x0, null, T, T, tMax, 1, false);
...
//        predictorCorrectorMethod.apply(A, x0, B, null, T, tMax, 2, 1, false);
...
//        predictorCorrectorMethod2.apply(A, x0, B, null, T, tMax, 1, 1, false);
