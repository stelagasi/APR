...
public class Task2 {
    public static void main(String[] args) {
        ...
        rungeKuttaMethod.apply(A, x0, B, null, T, tMax, 1, false);
        ...
        trapezoidalMethod.apply(x0, null, T, tMax, 1, false);
        ...
        eulerMethod.apply(A, x0, B, null, T, tMax, 1, false);
        ...
        backwardEulerMethod.apply(x0, null, T, tMax, 1, false);
