...
public class BinaryPopulationEvaluator implements IPopulationEvaluator<BinaryIndividual>{
    ...
    public double evaluatePenalty(List<BinaryIndividual> population, IFunction<Double> goalFunction) {
    ...
    public double evaluateFitness(List<BinaryIndividual> population, IFunction<Double> goalFunction) {
